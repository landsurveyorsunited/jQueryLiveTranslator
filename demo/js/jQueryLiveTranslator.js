...
(function($, window, document, undefined){
  var Translate = {
    initialize : function(pkg, options){
      ...
      this.options      = $.extend({}, $.fn.jqLTranslate.options, options);
    ...
    getUserLanguage : function(){
      var userLang = this.options.langToUse || this.options.forceLang || navigator.language || navigator.userLanguage;
      ...
      $.fn.jqLTranslate.userLang = userLang;
      return userLang;
    },
  ...
  $.fn.jqLTranslate = function(pkg, options){
    var self = this;
